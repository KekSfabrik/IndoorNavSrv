...
/**
 * A Beacon is an iBeacon, a bluetooth low energy technology based transmitter,
 * it is identified by its manufacturer UUID and its MAJOR and MINOR fields
 * signaling a group (MAJOR) and the individual device (MINOR).
 * 
 * @version 1.0
